...
class InjectorTest extends HackTest {
	...
	public function testSingleMultiLineParagraph() : void {
		$this->assertAutoParagraphResult('SingleMultiLineParagraph',
'Par 1
Par 1 still',
'<p>Par 1
Par 1 still</p>'
	...
	public function testTwoParagraphs() : void {
		$this->assertAutoParagraphResult('TwoParagraphs',
'Par1
...
<p>Par2</p>"
	...
	public function testTwoParagraphsWithLotsOfSpace() : void {
		$this->assertAutoParagraphResult('TwoParagraphsWithLotsOfSpace',
'Par1
...
<p>Par2</p>'
	...
	public function testBasicLink() : void{
		$this->assertDisplayURIResult('BasicLink',
	...
	public function testEmptyLink() : void {
		$this->assertDisplayURIResult('EmptyLink',
			'<a>Don\'t go here!</a>',
			'<a>Don\'t go here!</a>'
		);
	}
	...
	public function testPreserve() : void {
		$this->assertRemoveEmptyResult('Preserve',
			'<b>asdf</b>',
			'<b>asdf</b>'
		);
	}
	...
	public function testRemove() : void {
		$this->assertRemoveEmptyResult('Remove',
			'<b></b>',
			''
		);
	}
	...
	public function testRemoveWithSpace() : void {
		$this->assertRemoveEmptyResult('RemoveWithSpace',
			'<b>   </b>', 
			''
		);
	}
	...
	public function testRemoveWithAttr() : void {
		$this->assertRemoveEmptyResult('RemoveWithAttr',
			'<b class="asdf"></b>', 
			''
		);
	}
	...
	public function testNoTriggerCharacer() : void {
		$this->assertPurifierLinkifyResult('NoTriggerCharacter',
			'Foobar',
			'Foobar'
		);
	}
	...
	public function testTriggerCharacterInIrrelevantContext() : void {
		$this->assertPurifierLinkifyResult('TriggerCharacterInIrrelevantContext',
			'20% off!',
			'20% off!'
		);
	}
	...
	public function testPreserveNamespace() : void {
		$this->assertPurifierLinkifyResult('PreserveNamespace', 
	...
	public function testLinkifyBasic() : void {
		$this->assertPurifierLinkifyResult('LinkifyBasic',
			'%Namespace.Directive',
	...
	public function testLinkifyWithAdjacentTextNodes() : void {
		$this->assertPurifierLinkifyResult('LinkifyWithAdjacentTextNodes',
	...
	public function testLinkifyInBlock() : void {
		$this->assertPurifierLinkifyResult('LinkifyInBlock',
	...
	public function testPreserveInATag() : void {
		$this->assertPurifierLinkifyResult('PreserveInATag',
	...
	public function testLinkifyURLInRootNode() : void {
		$this->assertLinkifyResult('LinkifyURLInRootNode',
			'http://example.com',
	...
	public function testLinkifyURLInInlineNode() : void {
		$this->assertLinkifyResult('LinkifyURLInInlineNode',
	...
	public function testBasicUsageCase() : void {
		$this->assertLinkifyResult('BasicUsageCase',
	...
	public function testIgnoreURLInATag() : void {
		$this->assertLinkifyResult('IgnoreURLInATag',
	...
	public function testExcludes() : void {
		$this->assertLinkifyResult('Excludes',

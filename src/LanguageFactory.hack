...
class HTMLPurifier_LanguageFactory {
    ...
    */
    ...
    /**
    */
    private dict<string, HTMLPurifier_Language> $string_class_map = dict[/*'HTMLPurifier_Language_en_x_test' => HTMLPurifier_Language_en_x_test*/];
    ...
    */
    public function create(HTMLPurifier_Config $config, HTMLPurifier_Context $context, 
        string $code = 'false') : HTMLPurifier_Language {
            if ($code === 'false') {

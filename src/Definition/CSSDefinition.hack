...
class HTMLPurifier_CSSDefinition extends HTMLPurifier\HTMLPurifier_Definition {
	...
	protected function doSetup(HTMLPurifier\HTMLPurifier_Config $config): void {
		...
		$this->info['clear'] = new AttrDef\HTMLPurifier_AttrDef_Enum(vec['none', 'left', 'right', 'both'], false);
		$this->info['float'] = new AttrDef\HTMLPurifier_AttrDef_Enum(vec['none', 'left', 'right'], false);
		$this->info['font-style'] = new AttrDef\HTMLPurifier_AttrDef_Enum(vec['normal', 'italic', 'oblique'], false);
		...
		$this->info['list-style-position'] = new AttrDef\HTMLPurifier_AttrDef_Enum(vec['inside', 'outside'], false);
		...
		$this->info['border-collapse'] = new AttrDef\HTMLPurifier_AttrDef_Enum(vec['collapse', 'separate']);

		$this->info['caption-side'] = new AttrDef\HTMLPurifier_AttrDef_Enum(vec['top', 'bottom']);

		$this->info['table-layout'] = new AttrDef\HTMLPurifier_AttrDef_Enum(vec['auto', 'fixed']);
		...
		$this->info['border-spacing'] = new CSS\HTMLPurifier_AttrDef_CSS_Multiple(
			new CSS\HTMLPurifier_AttrDef_CSS_Length(),
			2,
		);
	...
	protected function doSetupTricky(HTMLPurifier\HTMLPurifier_Config $config): void {
		...
		$this->info['visibility'] = new AttrDef\HTMLPurifier_AttrDef_Enum(vec['visible', 'hidden', 'collapse']);
	...
	protected function doSetupTrusted(HTMLPurifier\HTMLPurifier_Config $config): void {
		$this->info['position'] = new AttrDef\HTMLPurifier_AttrDef_Enum(vec['static', 'relative', 'absolute', 'fixed']);

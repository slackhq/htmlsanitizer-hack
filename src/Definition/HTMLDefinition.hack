...
class HTMLPurifier_HTMLDefinition extends HTMLPurifier\HTMLPurifier_Definition {
	...
	public function __construct() {
		...
		$abbr_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$acronym_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$dfn_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$kbd_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$q_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["cite" => new AttrDef\HTMLPurifier_AttrDef_URI()],
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Optional(),
		...
		$samp_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$var_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$em_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$strong_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$code_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$span_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$br_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["clear" => new AttrDef\HTMLPurifier_AttrDef_Enum(vec["left", "all", "right", "none"])],
			$br_drop_attr,
			vec[],
			vec[],
		...
		$address_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Optional($address_child_elements),
			null,
			'',
			true,
			vec[],
		...
		$blockquote_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["width" => new AttrDef\HTMLPurifier_AttrDef_Integer()],
			vec[],
			vec[],
			vec[],
		...
		$pre_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["cite" => new AttrDef\HTMLPurifier_AttrDef_URI()],
			vec[],
			vec[],
		...
		$h1_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["align" => new AttrDef\HTMLPurifier_AttrDef_Enum(vec["left", "right", "center", "justify"])],
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Optional(),
		...
		$h2_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["align" => new AttrDef\HTMLPurifier_AttrDef_Enum(vec["left", "right", "center", "justify"])],
			vec[],
			vec[],
		...
		$h3_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["align" => new AttrDef\HTMLPurifier_AttrDef_Enum(vec["left", "right", "center", "justify"])],
			vec[],
			vec[],
		...
		$h4_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["align" => new AttrDef\HTMLPurifier_AttrDef_Enum(vec["left", "right", "center", "justify"])],
			vec[],
			vec[],
		...
		$h5_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["align" => new AttrDef\HTMLPurifier_AttrDef_Enum(vec["left", "right", "center", "justify"])],
			vec[],
			vec[],
		...
		$h6_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["align" => new AttrDef\HTMLPurifier_AttrDef_Enum(vec["left", "right", "center", "justify"])],
			vec[],
			vec[],
		...
		$p_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["align" => new AttrDef\HTMLPurifier_AttrDef_Enum(vec["left", "right", "center", "justify"])],
			vec[],
			vec[],
		...
		$ol_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$ol_add_attr,
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_List(),
			null,
			'',
			false,
			vec[],
		...
		$ul_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$ul_add_attr,
			vec[],
			vec[],
		...
		$dl_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["compact" => new HTML\HTMLPurifier_AttrDef_HTML_Bool()],
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Required(dict["dt" => true, "dd" => true]),
			null,
			'',
			false,
			vec[],
		...
		$li_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$li_add_attr,
			vec[],
			vec[],
		...
		$dd_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$dt_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$hr_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$hr_add_attr,
			vec[],
			vec[],
		...
		$sub_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$sup_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$b_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$big_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$i_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$small_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$tt_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$ins_child_element = new ChildDef\HTMLPurifier_ChildDef_Chameleon(
			new ChildDef\HTMLPurifier_ChildDef_Optional(),
			new ChildDef\HTMLPurifier_ChildDef_Optional($alt_child_elements),
		);
		$ins_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["cite" => new AttrDef\HTMLPurifier_AttrDef_URI()],
			vec[],
			vec[],
		...
		$bdo_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$caption_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["align" => new AttrDef\HTMLPurifier_AttrDef_Enum(vec["top", "bottom", "left", "right"])],
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Optional(),
		...
		$table_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$table_add_attr,
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Table(),
			null,
			'',
			false,
			vec[],
		...
		$del_child_element = new ChildDef\HTMLPurifier_ChildDef_Chameleon(
			new ChildDef\HTMLPurifier_ChildDef_Optional(),
			new ChildDef\HTMLPurifier_ChildDef_Optional($alt_child_elements),
		);
		$del_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["cite" => new AttrDef\HTMLPurifier_AttrDef_URI()],
			vec[],
			vec[],
		...
		$td_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$td_add_attr,
			vec[],
			vec[],
		...
		$tr_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$tr_add_attr,
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Required(dict["td" => true, "th" => true]),
			null,
			'',
			false,
			vec[],
		...
		$th_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$td_add_attr,
			vec[],
			vec[],
		...
		$col_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$col_add_attr,
			vec[],
			vec[],
		...
		$colgroup_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$col_add_attr,
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Optional(dict["col" => true]),
			null,
			'',
			false,
			vec[],
		...
		$tbody_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$tbody_add_attr,
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Required(dict["tr" => true]),
			null,
			'',
			false,
			vec[],
		...
		$thead_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$thead_add_attr,
			vec[],
			vec[],
		...
		$tfoot_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$tfoot_add_attr,
			vec[],
			vec[],
		...
		$basefont_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$basefont_add_attr,
			$basefont_drop_attr,
			vec[],
		...
		$center_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$dir_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["compact" => new HTML\HTMLPurifier_AttrDef_HTML_Bool()],
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Required(dict["li" => true]),
			null,
			'',
			false,
			vec[],
		...
		$font_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$font_add_attr,
			vec[],
			vec[],
		...
		$menu_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["compact" => new HTML\HTMLPurifier_AttrDef_HTML_Bool()],
			vec[],
			vec[],
		...
		$s_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$strike_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$u_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$iframe_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$iframe_add_attr,
			$iframe_drop_attr,
			vec[],
		...
		$article_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$nav_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$section_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$header_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$footer_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$hgroup_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Required(
				dict["h1" => true, "h2" => true, "h3" => true, "h4" => true, "h5" => true, "h6" => true],
			),
			null,
			'Flow | #PCDATA',
			true,
		...
		$main_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$figcaption_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			false,
			dict[],
			vec[],
			vec[],
		...
		$mark_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$wbr_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$audio_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$audio_add_attrs,
			vec[],
			vec[],
		...
		$source_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			false,
			$source_add_attrs,
			vec[],
			vec[],
		...
		$track_add_attrs = dict[
			"kind" => new AttrDef\HTMLPurifier_AttrDef_Enum(
				vec["captions", "chapters", "descriptions", "metadata", "subtitles"],
			),
			"src" => new AttrDef\HTMLPurifier_AttrDef_URI(),
		...
		$track_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			false,
			$track_add_attrs,
			vec[],
			vec[],
		...
		$picture_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Required(dict["img" => true]),
			null,
			'Flow | #PCDATA',
			true,
			vec[],
		...
		$progress_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			$progress_add_attrs,
			vec[],
			vec[],
		...
		$summary_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			false,
			dict[],
			vec[],
			vec[],
		...
		$dialog_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict["open" => new AttrDef\HTML\HTMLPurifier_AttrDef_HTML_Bool("open")],
			vec[],
			vec[],
			vec[],
			new ChildDef\HTMLPurifier_ChildDef_Optional(),
		...
		$bdi_element = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
		...
		$this->info_parent_def = new HTMLPurifier\HTMLPurifier_ElementDef(
			true,
			dict[],
			vec[],
			vec[],
	...
	public function addAttribute(
		string $element_name,
		string $attr_name,
		HTMLPurifier\HTMLPurifier_AttrDef $def,
	): void {
	...
	protected function setupConfigStuff(HTMLPurifier\HTMLPurifier_Config $config): void {
		...
		if (
			C\contains_key($this->info_content_sets, 'Block') &&
			C\contains_key($this->info_content_sets['Block'], $block_wrapper) &&
			$this->info_content_sets['Block'][$block_wrapper] is nonnull
		) {
		...
		if (
			$allowed_elements is dict<_, _> &&
			C\is_empty($allowed_elements) &&
			$allowed_attributes is dict<_, _> &&
		...
		if (
			$allowed_attributes is dict<_, _> &&
			!C\is_empty($allowed_attributes) &&
			$allowed_attributes_mutable is dict<_, _> &&
			!C\is_empty($allowed_attributes_mutable)
		) {
			...
			foreach ($this->info_global_attr as $attr => $x) {
				...
				$delete = true;
				foreach ($keys as $key) {
					if ($delete && C\contains_key($allowed_attributes, $key) && $allowed_attributes[$key] is nonnull) {
						$delete = false;
					}
					if (
						C\contains_key($allowed_attributes_mutable, $key) &&
			...
			foreach ($allowed_attributes_mutable as $elattr => $d) {
				...
				switch ($c) {
					...
					case 1:
						...
						throw new \Error(
							"Global attribute '$attribute' is not "."supported in any elements $support",
							\E_USER_WARNING,
						);
						break;
				}

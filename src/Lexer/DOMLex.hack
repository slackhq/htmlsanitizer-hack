...
class HTMLPurifier_Lexer_DOMLex extends HTMLPurifier\HTMLPurifier_Lexer {
    ...
    public function tokenizeHTML(string $html, 
    ...
    public function tokenizeDOM(\DOMNode $node, inout vec<HTMLPurifier\HTMLPurifier_Token> $tokens,
        HTMLPurifier\HTMLPurifier_Config $config): void {
        $level = 0;
    ...
    */
    protected function createStartNode(\DOMNode $node, inout vec<HTMLPurifier\HTMLPurifier_Token> $tokens, 
        bool $collect, HTMLPurifier\HTMLPurifier_Config $config): bool {
    ...
    protected function wrapHTML(string $html, HTMLPurifier\HTMLPurifier_Config $config, 
        HTMLPurifier\HTMLPurifier_Context $_context, ?bool $use_div = true) : string {

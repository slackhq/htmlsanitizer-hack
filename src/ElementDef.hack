 ...
 *          the mergeIn() method.
 * MOST OF THIS CLASS IS NOT NEEDED FOR MVP - 6/17/20
 */
class HTMLPurifier_ElementDef {
     ...
     */
    public dict<string, HTMLPurifier_AttrDef> $attr = dict[];
    ...
    //  * @type array
    //  */
    // public vec<HTMLPurifier_AttrTransform> $attr_transform_pre = vec[];

    // /**
    //  * List of tags HTMLPurifier_AttrTransform to be done after validation.
    //  * @type array
    //  */
    // public vec<HTMLPurifier_AttrTransform> $attr_transform_post = vec[];
    ...
    //  * @type bool
    //  */
    // public bool $descendants_are_inline = false;
    ...
    //  * @type array
    //  */
    // public vec<string> $required_attr = vec[];
    ...
    //  *       distinctions.
    //  */
    // public vec<string> $excludes = vec[];

    // /**
    //  * This tag is explicitly auto-closed by the following tags.
    //  * @type array
    //  */
    // public vec<string> $autoclose = vec[];
    ...
    //     if ($def->content_model) {
    //         $this->content_model =
    //             str_replace("#SUPER", $this->content_model, $def->content_model);
    //         $this->child = false;
    //     }
    //     if ($def->content_model_type) {

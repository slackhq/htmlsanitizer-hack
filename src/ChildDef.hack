...
abstract class HTMLPurifier_ChildDef {
    ...
    abstract public function validateChildren(vec<HTMLPurifier_Node> $children, HTMLPurifier_Config $config, HTMLPurifier_Context $context): (bool, vec<HTMLPurifier_Node>);
}

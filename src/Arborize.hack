...
class HTMLPurifier_Arborize {
    public static function arborize(vec<HTMLPurifier_Token> $tokens, HTMLPurifier_Config $config, HTMLPurifier_Context $context): ?HTMLPurifier_Node {
    ...
    public static function flatten(HTMLPurifier_Node $node, HTMLPurifier_Config $config, HTMLPurifier_Context $context): vec<HTMLPurifier_Token> {
        $level = 0;

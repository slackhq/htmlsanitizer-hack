...
// Class defined but not used in MVP - 6/17/20
class HTMLPurifier_ContentSets {
	...
	//  */
	// public dict<string, bool> $lookup = dict[];
	 ...
	 */
	public function __construct(dict<string, HTMLPurifier_HTMLModule> $_modules): void {
		throw new \Error("CONTENT SETS NEEDS IMPLEMENTATION");
	}
	//     if (!is_array($modules)) {

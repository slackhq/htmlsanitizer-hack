...
class HTMLPurifier_URIFilter_Munge extends HTMLPurifier\HTMLPurifier_URIFilter {
     ...
     * @param HTMLPurifier_Context $context
     */
    protected function makeReplace(HTMLPurifier\HTMLPurifier_URI $uri, HTMLPurifier\HTMLPurifier_Config $_config,
        HTMLPurifier\HTMLPurifier_Context $context): void {
        $string = $uri->toString();
        // always available
